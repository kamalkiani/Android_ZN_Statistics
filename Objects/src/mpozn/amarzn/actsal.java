...
public class actsal extends Activity implements B4AActivity{
	public static actsal mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "mpozn.amarzn", "mpozn.amarzn.actsal");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actsal).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "mpozn.amarzn", "mpozn.amarzn.actsal");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "mpozn.amarzn.actsal", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actsal) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actsal) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actsal) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 40;BA.debugLine="dir=DBUtils.CopyDBFromAssets(\"amar96.db\")";
...
if (_firsttime) { 
 //BA.debugLineNum = 42;BA.debugLine="SQL1.Initialize(dir, \"amar96.db\", False)";
_sql1.Initialize(_dir,"amar96.db",anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 45;BA.debugLine="Activity.LoadLayout(\"laySal\")";
mostCurrent._activity.LoadLayout("laySal",mostCurrent.activityBA);
 //BA.debugLineNum = 46;BA.debugLine="titleLabel.Text = Main.pageTitle";
mostCurrent._titlelabel.setText(BA.ObjectToCharSequence(mostCurrent._main._pagetitle));
 //BA.debugLineNum = 48;BA.debugLine="myFont= Typeface.LoadFromAssets(\"BYekan.ttf\")";
mostCurrent._myfont.setObject((android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("BYekan.ttf")));
 //BA.debugLineNum = 49;BA.debugLine="SetTypeface(mainPanel,myFont)";
_settypeface(mostCurrent._mainpanel,mostCurrent._myfont);
 //BA.debugLineNum = 51;BA.debugLine="BuildItems_groh";
_builditems_groh();
...
public static String  _btnsearch_click() throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub btnSearch_Click";
 //BA.debugLineNum = 94;BA.debugLine="StartActivity(actSearch)";
...
int _i = 0;
 //BA.debugLineNum = 61;BA.debugLine="Sub BuildItems_groh";
 //BA.debugLineNum = 62;BA.debugLine="grohListView.Clear";
mostCurrent._grohlistview.Clear();
 //BA.debugLineNum = 63;BA.debugLine="grohListView.TwoLinesAndBitmap.ItemHeight = 12%y";
mostCurrent._grohlistview.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (12),mostCurrent.activityBA));
 //BA.debugLineNum = 64;BA.debugLine="grohListView.TwoLinesAndBitmap.Label.TextColor =";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 //BA.debugLineNum = 65;BA.debugLine="grohListView.TwoLinesAndBitmap.SecondLabel.TextCo";
mostCurrent._grohlistview.getTwoLinesAndBitmap().SecondLabel.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 66;BA.debugLine="grohListView.TwoLinesAndBitmap.Label.Gravity = Gr";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Label.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.RIGHT);
 //BA.debugLineNum = 67;BA.debugLine="grohListView.TwoLinesAndBitmap.SecondLabel.Gravit";
mostCurrent._grohlistview.getTwoLinesAndBitmap().SecondLabel.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.RIGHT);
 //BA.debugLineNum = 68;BA.debugLine="grohListView.TwoLinesAndBitmap.Label.TextSize = 1";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Label.setTextSize((float) (18));
 //BA.debugLineNum = 69;BA.debugLine="grohListView.TwoLinesAndBitmap.SecondLabel.TextSi";
mostCurrent._grohlistview.getTwoLinesAndBitmap().SecondLabel.setTextSize((float) (18));
 //BA.debugLineNum = 70;BA.debugLine="grohListView.TwoLinesAndBitmap.Label.Typeface = m";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Label.setTypeface((android.graphics.Typeface)(mostCurrent._myfont.getObject()));
 //BA.debugLineNum = 71;BA.debugLine="grohListView.TwoLinesAndBitmap.SecondLabel.Typefa";
mostCurrent._grohlistview.getTwoLinesAndBitmap().SecondLabel.setTypeface((android.graphics.Typeface)(mostCurrent._myfont.getObject()));
 //BA.debugLineNum = 72;BA.debugLine="grohListView.TwoLinesAndBitmap.Label.SetLayout(15";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Label.SetLayout((int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 73;BA.debugLine="grohListView.TwoLinesAndBitmap.SecondLabel.SetLay";
mostCurrent._grohlistview.getTwoLinesAndBitmap().SecondLabel.SetLayout((int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (6),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 74;BA.debugLine="grohListView.TwoLinesAndBitmap.ImageView.SetLayou";
mostCurrent._grohlistview.getTwoLinesAndBitmap().ImageView.SetLayout(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (17),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (17),mostCurrent.activityBA));
 //BA.debugLineNum = 75;BA.debugLine="grohListView.Color = Colors.Transparent";
mostCurrent._grohlistview.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 76;BA.debugLine="Dim gd As ColorDrawable";
_gd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 77;BA.debugLine="gd.Initialize(Colors.RGB(240,240,240),0)";
_gd.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (240),(int) (240),(int) (240)),(int) (0));
 //BA.debugLineNum = 78;BA.debugLine="grohListView.TwoLinesAndBitmap.Background = gd";
mostCurrent._grohlistview.getTwoLinesAndBitmap().Background = (android.graphics.drawable.Drawable)(_gd.getObject());
 //BA.debugLineNum = 80;BA.debugLine="Cursor1 = SQL1.ExecQuery(\"SELECT * FROM parent\")";
mostCurrent._cursor1.setObject((android.database.Cursor)(_sql1.ExecQuery("SELECT * FROM parent")));
...
mostCurrent._cursor1.setPosition(_i);
 //BA.debugLineNum = 83;BA.debugLine="grohListView.AddTwoLinesAndBitmap2(Cursor1.GetSt";
mostCurrent._grohlistview.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._cursor1.GetString("pchapter")),BA.ObjectToCharSequence(mostCurrent._cursor1.GetString("pname")),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"picon/ch"+BA.NumberToString((_i+1))+".png").getObject()),(Object)(mostCurrent._cursor1.GetString("pid")));
 }
};
 //BA.debugLineNum = 85;BA.debugLine="Cursor1.Close";
...
mostCurrent._mainpanel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Private titleLabel As Label";
mostCurrent._titlelabel = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private grohListView As ListView";
...
public static String  _grohlistview_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub grohListView_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 89;BA.debugLine="actSalChild.pid = Value";
mostCurrent._actsalchild._pid = BA.ObjectToString(_value);
 //BA.debugLineNum = 90;BA.debugLine="StartActivity(actSalChild)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actsalchild.getObject()));
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 27;BA.debugLine="Sub SetTypeface(parent As Panel, t As Typeface)";
 //BA.debugLineNum = 28;BA.debugLine="For Each v As View In parent";
...
_v.setObject((android.view.View)(group1.Get(index1)));
 //BA.debugLineNum = 29;BA.debugLine="If v Is Panel Then";
if (_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
 //BA.debugLineNum = 30;BA.debugLine="SetTypeface(v, t)";
_settypeface((anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(_v.getObject())),_t);
 ...
 //BA.debugLineNum = 32;BA.debugLine="Dim lbl As Label = v";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl.setObject((android.widget.TextView)(_v.getObject()));
 //BA.debugLineNum = 33;BA.debugLine="lbl.Typeface = t";
